...
class DCGAN (tf.keras.Model):
    ...
    def __init__(self, gen_dict, disc_dict, batch_size, model_name, distribute, slow_train=True): #defualt to slow training
        ...
        self.gen_model = create_generator_dict(gen_dict)#create generator by calling generator function with dict
        self.disc_model = create_discriminator_dict(disc_dict, self.gen_model.output_shape)#create discriminator by calling generator function with dict
